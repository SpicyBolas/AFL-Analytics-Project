...
SeasonList = list(range(13))
RoundCodes = {0:'r6',1:'ra',2:'r8',3:'r8',4:'ra',5:'rc',6:'re',7:'rg',8:'ri',9:'rk',10:'rm',11:'ro',12:'rq'}
###########################
#MAIN CODE#
...
for season_iter in SeasonList:
    round_code = RoundCodes[season_iter]
    ...
    time.sleep(2)
    #Select 
    season_elem = driver.find_element(By.ID,f'downshift-:r4:-item-{season_iter}')
